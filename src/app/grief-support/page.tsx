...
export default function GriefSupport() {
  return (
    <Layout>
      <JsonLd data={customProfessionalServiceJsonLd({ serviceType: "Grief Support", url: `${SITE_URL}/grief-support` })} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl lg:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Professional support for men navigating grief, loss, and life transitions
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our CRPO registered therapists provide specialized support to help men process grief and loss in healthy ways.
              </p>
            </div>
          </div>
        </section>
