        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-64 bg-white shadow-lg rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="py-2">
                  ...
                  <Link href="/performance-anxiety" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Performance Anxiety
                  </Link>
                  <Link href="/work-life-balance" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Work-Life Balance
                  </Link>
                  <Link href="/mens-issues" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Men's Issues
                  </Link>
                  <Link href="/for-partners" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Support for Partners
                  </Link>
                  <Link href="/parenting-support" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Parenting Support
                  </Link>
                  <Link href="/grief-support" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Grief Support
                  </Link>
                  <Link href="/first-responder-support" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    First Responder Support
                  </Link>
                  <Link href="/emdr-therapy" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    EMDR Therapy
                  </Link>
                </div>
              </div>
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-56 bg-white shadow-lg rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="py-2">
                  <Link href="/toronto" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Toronto
                  </Link>
                  <Link href="/ottawa" className="block px-4 py-2 text-gray-700 hover:bg-resolve-sage/20 hover:text-resolve-forest">
                    Ottawa
                  </Link>
                </div>
              </div>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-t">
          <nav className="px-4 py-4 space-y-4">
            ...
            <div className="pl-4 text-sm text-muted-foreground space-y-2">
              <Link href="/performance-anxiety" className="block hover:text-resolve-forest">Performance Anxiety</Link>
              <Link href="/work-life-balance" className="block hover:text-resolve-forest">Work-Life Balance</Link>
              <Link href="/mens-issues" className="block hover:text-resolve-forest">Men's Issues</Link>
              <Link href="/for-partners" className="block hover:text-resolve-forest">Support for Partners</Link>
              <Link href="/parenting-support" className="block hover:text-resolve-forest">Parenting Support</Link>
              <Link href="/grief-support" className="block hover:text-resolve-forest">Grief Support</Link>
              <Link href="/first-responder-support" className="block hover:text-resolve-forest">First Responder Support</Link>
              <Link href="/emdr-therapy" className="block hover:text-resolve-forest">EMDR Therapy</Link>
            </div>
            ...
            <div className="pt-2">
              <p className="text-xs font-semibold uppercase text-muted-foreground tracking-wide">Locations</p>
              <div className="pl-4 mt-2 space-y-2 text-sm text-muted-foreground">
                <Link href="/toronto" className="block hover:text-resolve-forest">Toronto</Link>
                <Link href="/ottawa" className="block hover:text-resolve-forest">Ottawa</Link>
              </div>
            </div>
