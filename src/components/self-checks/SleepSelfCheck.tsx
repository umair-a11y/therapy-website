...
const questions: readonly Question[] = [
  {
    key: "q1",
    text: "Overall sleep quality in the past 2 weeks",
    options: [
  ...
  {
    key: "q2",
    text: "Time to fall asleep most nights",
    options: [
      { label: "< 20 minutes", value: 1 },
      { label: "20-40 minutes", value: 2 },
      { label: "40-60 minutes", value: 3 },
      { label: "> 60 minutes", value: 4 }
    ],
  },
  {
    key: "q3",
    text: "Night awakenings that disrupt sleep",
    options: [
      { label: "Rarely", value: 1 },
      { label: "Sometimes", value: 2 },
      { label: "Often", value: 3 },
      { label: "Most nights", value: 4 }
    ],
  },
  {
    key: "q4",
    text: "Daytime sleepiness/energy",
    options: [
      { label: "Energized", value: 1 },
      { label: "Mostly okay", value: 2 },
      { label: "Often tired", value: 3 },
      { label: "Exhausted", value: 4 }
    ],
  },
] as const;
